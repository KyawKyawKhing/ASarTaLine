...
public class WarDeeListAdapter extends BaseRecyclerAdapter<WarDeeListViewHolder, AstlWarDee> {
    private HomeDelegate homeDelegate;
    public WarDeeListAdapter(Context context, HomeDelegate homeDelegate) {
        super(context);
    ...
    public WarDeeListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.wardee_list_item, parent, false);
